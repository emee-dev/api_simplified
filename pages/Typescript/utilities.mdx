...
description: The utility functions of Typescript best for certain use cases
...
The Pick utility type helps us create a new type by allowing us pick the keys we need from an existing type
...
The Omit utility type helps us create a new type by allowing us exclude the keys we don't need from an existing type.
